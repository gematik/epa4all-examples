...
public class TLSExample13 {
	
	public static final String urlServer = "https://127.0.0.1:8443";

	// [gemSpec_Krypt#A_15751-02, ePA-spezifische TLS-Vorgaben]
	public static final String[] vecCiphers = new String[] {"TLS_AES_128_GCM_SHA256", "TLS_AES_256_GCM_SHA384"};

	// [gemSpec_Krypt#GS-A_4385, gemSpec_Krypt#A_18467]
	public static final String[] vecProtocols = new String[] { "TLSv1.3" };
	...
	public static void createTLSSession(String urlServer, KeystoreInfo ksInfo, KeystoreInfo tsInfo) {
		...
		try {
			...
			params.setSignatureSchemes(new String[] {SignatureScheme.getName(SignatureScheme.ecdsa_brainpoolP256r1tls13_sha256)});
	...
	public static void main(String[] args) {
		KeystoreInfo ksInfo = new KeystoreInfo(
				TLSExample13.class.getClassLoader().getResource("client/clientksbrain.bks").getFile(), "00", "BKS", "testclient102");

		KeystoreInfo tsInfo = new KeystoreInfo(
				TLSExample13.class.getClassLoader().getResource("client/clientts.jks").getFile(), "00", "PKCS12", "testserver 101");
	...
	public static void bouncyCastleSetup() {
		...
		Security.setProperty("jdk.tls.namedGroups","brainpoolP256r1,brainpoolP384r1,brainpoolP512r1");
		System.setProperty("jdk.tls.namedGroups", "brainpoolP256r1,brainpoolP384r1,brainpoolP512r1");
		Security.setProperty("jdk.tls.client.SignatureSchemes", SignatureScheme.getName(SignatureScheme.ecdsa_brainpoolP256r1tls13_sha256));
		Security.setProperty("jdk.tls.server.SignatureSchemes", SignatureScheme.getName(SignatureScheme.ecdsa_brainpoolP256r1tls13_sha256));
